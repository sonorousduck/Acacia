...
namespace SpaceGuy
{
	...
	{
		Ebony::ResourceManager::LoadTexture("Button_Unpressed.tx", "button_unpressed", "SpaceGuy");
		Ebony::ResourceManager::LoadTexture("Button_Pressed.tx", "button_pressed", "SpaceGuy");
		Ebony::ResourceManager::LoadTexture("Button_Hovered.tx", "button_hovered", "SpaceGuy");
		Ebony::ResourceManager::LoadTexture("Start_Text.tx", "start_text", "SpaceGuy");
		Ebony::ResourceManager::LoadTexture("Options_Text.tx", "options_text", "SpaceGuy");
		Ebony::ResourceManager::LoadTexture("Quit_Text.tx", "quit_text", "SpaceGuy");
	}
	...
	void MainMenuScreen::Start()
	{
		...
		auto button = SpaceGuy::Button::Create(0.0f, 120.0f, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", SpaceGuy::ScreenEnum::GAME, [=](std::uint16_t nextScreen) {SetNextScreen(nextScreen); });
		...
		AddEntity(SpaceGuy::MenuCursor::Create());
		AddEntity(SpaceGuy::ButtonText::Create(buttonPositioningX, 120.0f, actualButtonScale.x, actualButtonScale.y, "start_text"));
		AddEntity(SpaceGuy::Button::Create(0.0f, 130.0f + actualButtonScale.y, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", SpaceGuy::ScreenEnum::OPTIONS, [=](std::uint16_t nextScreen) { SetNextScreen(nextScreen); }));
		AddEntity(SpaceGuy::ButtonText::Create(buttonPositioningX, 130.0f + actualButtonScale.y, actualButtonScale.x, actualButtonScale.y, "options_text"));
		AddEntity(SpaceGuy::Button::Create(0.0f, 140.0f + 2 * actualButtonScale.y, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", SpaceGuy::ScreenEnum::QUIT, [=](std::uint16_t nextScreen) {SetNextScreen(nextScreen); }));
		AddEntity(SpaceGuy::ButtonText::Create(buttonPositioningX, 140.0f + 2.0f * actualButtonScale.y, actualButtonScale.x, actualButtonScale.y, "quit_text"));



		//AddEntity(SpaceGuy::ButtonText::Create(buttonWidth, 460.0f + buttonHeight, "quit_text"));

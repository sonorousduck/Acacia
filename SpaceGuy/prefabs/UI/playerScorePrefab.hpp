...
namespace SpaceGuy
{
	...
	public:
		static entities::EntityPtr Create(int windowWidth, entities::EntityPtr player)
		{
			...
			auto text = std::make_unique<components::Text>("Score: 0", Ebony::Color::Color(255, 255, 255), Ebony::Colors::Black, Ebony::ResourceManager::GetFont("evil_empire_12"), Ebony::RenderLayer::UI_RENDER);
			...
			entity->addComponent(std::make_unique<components::Transform>(glm::vec2(16.5f , 16.0f), 0.0f, glm::vec2(1.0f, 1.0f)));

...
namespace SpaceGuy
{
	...
	{
	public:
		static entities::EntityPtr Create(float width, float height, float screenWidth, const char* spriteImageUnpressed, const char* spriteImageHover, const char* spriteImagePressed, SpaceGuy::ScreenEnum screenEnum, std::function<void(std::uint16_t)> setNextScreen)
		{

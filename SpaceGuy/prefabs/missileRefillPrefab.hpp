...
namespace SpaceGuy
{
	...
	public:
		...
		static entities::EntityPtr Create(glm::vec2 startTransform)
		{
			...
			auto sprite = std::make_unique<components::Sprite>(Ebony::ResourceManager::GetShader("default"), Ebony::ResourceManager::GetTexture("missile_refill"), Ebony::Colors::White, Ebony::RenderLayer::FOREGROUND);
			...
			aabbcollider.onCollisionStart = [=](entities::EntityPtr other, std::chrono::microseconds elapsedTime)
				{
					...
					playerInformation->missileCount += playerInformation->missilesToGain;

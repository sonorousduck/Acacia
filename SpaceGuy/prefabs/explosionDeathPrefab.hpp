...
namespace Crypt
{
	...
	public:
		static entities::EntityPtr Create(glm::vec2 startTransform, glm::vec2 scale)
		{
			...
			soundeffects->soundEffectQueue.push_back(Ebony::IndividualSound(Ebony::ResourceManager::GetSoundEffect("explosion"), 127));

			explosion->addComponent(std::move(soundeffects));

...
namespace EcologyRTS
{
	...
	{
	public:
		static entities::EntityPtr Create(float width, float height, float screenWidth, const char* spriteImageUnpressed, const char* spriteImageHover, const char* spriteImagePressed, EcologyRTS::ScreenEnum screenEnum, std::function<void(std::uint16_t)> setNextScreen)
		{

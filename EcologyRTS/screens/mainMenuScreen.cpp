...
namespace EcologyRTS
{
	...
	{
		Ebony::ResourceManager::LoadTexture("Button_Unpressed.tx", "button_unpressed", "EcologyRTS");
		Ebony::ResourceManager::LoadTexture("Button_Pressed.tx", "button_pressed", "EcologyRTS");
		Ebony::ResourceManager::LoadTexture("Button_Hovered.tx", "button_hovered", "EcologyRTS");
		Ebony::ResourceManager::LoadTexture("Start_Text.tx", "start_text", "EcologyRTS");
		Ebony::ResourceManager::LoadTexture("Options_Text.tx", "options_text", "EcologyRTS");
		Ebony::ResourceManager::LoadTexture("Quit_Text.tx", "quit_text", "EcologyRTS");
	}
	...
	void MainMenuScreen::Start()
	{
		...
		auto button = EcologyRTS::Button::Create(0.0f, 120.0f, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", EcologyRTS::ScreenEnum::GAME, [=](std::uint16_t nextScreen) {SetNextScreen(nextScreen); });
		...
		AddEntity(EcologyRTS::MenuCursor::Create());
		AddEntity(EcologyRTS::ButtonText::Create(buttonPositioningX, 120.0f, actualButtonScale.x, actualButtonScale.y, "start_text"));
		AddEntity(EcologyRTS::Button::Create(0.0f, 130.0f + actualButtonScale.y, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", EcologyRTS::ScreenEnum::OPTIONS, [=](std::uint16_t nextScreen) { SetNextScreen(nextScreen); }));
		AddEntity(EcologyRTS::ButtonText::Create(buttonPositioningX, 130.0f + actualButtonScale.y, actualButtonScale.x, actualButtonScale.y, "options_text"));
		AddEntity(EcologyRTS::Button::Create(0.0f, 140.0f + 2 * actualButtonScale.y, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", EcologyRTS::ScreenEnum::QUIT, [=](std::uint16_t nextScreen) {SetNextScreen(nextScreen); }));
		AddEntity(EcologyRTS::ButtonText::Create(buttonPositioningX, 140.0f + 2.0f * actualButtonScale.y, actualButtonScale.x, actualButtonScale.y, "quit_text"));



		//AddEntity(EcologyRTS::ButtonText::Create(buttonWidth, 460.0f + buttonHeight, "quit_text"));

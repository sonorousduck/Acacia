...
namespace EcologyRTS
{
	...
	void PauseScreen::LoadContent()
	{
		...
		Ebony::ResourceManager::LoadTexture("Resume_Text.tx", "resume_text", "EcologyRTS");
	...
	void PauseScreen::Start()
	{
		...
		auto button = EcologyRTS::Button::Create(0.0f, 140.0f, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", EcologyRTS::ScreenEnum::GAME, [=](std::uint16_t nextScreen) {SetNextScreen(nextScreen); });
		...
		AddEntity(EcologyRTS::ButtonText::Create(buttonPositioningX, 140.0f, actualButtonScale.x, actualButtonScale.y, "resume_text"));

		

		AddEntity(EcologyRTS::Button::Create(0.0f, 150.0f + actualButtonScale.y, static_cast<float>(windowWidth), "button_unpressed", "button_hovered", "button_pressed", EcologyRTS::ScreenEnum::QUIT, [=](std::uint16_t nextScreen) {SetNextScreen(nextScreen); }));
		AddEntity(EcologyRTS::ButtonText::Create(buttonPositioningX, 150.0f + actualButtonScale.y, actualButtonScale.x, actualButtonScale.y, "quit_text"));

...
namespace BrickBreaker
{
	...
	{
	public:
		static entities::EntityPtr Create(float width, float height, float screenWidth, const char* spriteImageUnpressed, const char* spriteImageHover, const char* spriteImagePressed, BrickBreaker::ScreenEnum screenEnum)
		{

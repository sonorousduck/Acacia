...
namespace components
{
	...
	public:
		...
		EnemyDetection(float detectionRange, float movementRange, float movementSpeed, glm::vec2 offset, float shootSpeed, const char* shootSprite, entities::EntityPtr target, float rotationOffset = 0.0f) : 

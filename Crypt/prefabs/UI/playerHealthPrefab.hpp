...
namespace Crypt
{
	...
	public:
		static entities::EntityPtr Create(int windowWidth)
		{
			...
			auto textComponent = std::make_unique<components::Text>("10/10", Ebony::Colors::Black, Ebony::Colors::White, Ebony::ResourceManager::GetFont("default"), 0.15f, true, true, glm::vec2(1.0f, 1.0f));
			...
			entity->addComponent(std::move(std::make_unique<components::Transform>(glm::vec2{ 300.0f, 100.0f }, 10.0f, glm::vec2{ 100.0f, 50.0f })));
